    ...
    <div ref={searchRef} className={`relative ${className}`}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2 text-sm border border-gray-300 rounded-lg bg-gray-50
              ...
              {searchResults.map((result, index) => {
                ...
                return (
                  <button
                    ...
                    className="w-full px-3 py-2.5 flex items-center gap-3 hover:bg-gray-50 transition-colors duration-150"
                  >
